...
func (s *versionedAPI) ListDiskIDs(context context.Context, versionedRequest *v1alpha1.ListDiskIDsRequest) (*v1alpha1.ListDiskIDsResponse, error) {
	request := &internal.ListDiskIDsRequest{}
	if err := Convert_v1alpha1_ListDiskIDsRequest_To_internal_ListDiskIDsRequest(versionedRequest, request); err != nil {
		return nil, err
	}
	...
	versionedResponse := &v1alpha1.ListDiskIDsResponse{}
	if err := Convert_internal_ListDiskIDsResponse_To_v1alpha1_ListDiskIDsResponse(response, versionedResponse); err != nil {
		return nil, err
	}
